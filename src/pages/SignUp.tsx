                    ...
                    <div className="space-y-6">
                      <div className="space-y-4">
                        ...
                        <select
                          ...
                          className="w-full h-12 px-4 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 text-lg bg-white dark:bg-slate-800"
                        >
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="relative">
                          <input
                            ...
                            className="w-full h-12 px-4 pr-10 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 text-lg bg-white dark:bg-slate-800"
                          />
